...
(function($) {
    ...
    Galleria.addTheme({
        ...
        init: function(options) {
            ...
            // add some elements
            this.addElement('bar','fullscreen','play','popout', 'download','thumblink','s1','s2','s3','s4','s5','progress');
            this.append({
                'stage' : 'progress',
                'container': ['bar','tooltip'],
                'bar'   : ['fullscreen','play','popout', 'download','thumblink','info','s1','s2','s3','s4', 's5']
            });
